# This script is used to extract the spectrogram features and log mel features of audio
...
# 1. extract STFT spectrogram
wav_file_path = 'audio/airport-lisbon-1000-40000-a.wav'    # read audio
